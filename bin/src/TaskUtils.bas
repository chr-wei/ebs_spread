...
Function SetEbsEstimates(sheet As Worksheet, userEstimate As Double)
        ...
        '  contribPool: The velocity pool of the user of the sheet
        ...
        'Generation of velocity pool might close the current sheet (virtual sheet management + reading a lot of estimate values closes sheets)
        'Re-read sheet again. Todo: Change this in a later release to use exisiting pool in EbsSheet
        Set sheet = TaskUtils.GetTaskSheet(tHash)
